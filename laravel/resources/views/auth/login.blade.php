...
<body class="bg-black text-white antialiased overflow-x-hidden">
    ...
    <div class="flex min-h-screen bg-[#000000] p-3 sm:p-4 lg:p-6">
        ...
        {{-- Right: Form Section --}}
        <div class="flex flex-1 flex-col justify-center px-8 py-12 sm:px-12 lg:px-24 xl:px-32 bg-[#000000] z-10 relative">
            <div class="mx-auto w-full max-w-[400px]">
                ...
                <div class="mb-10">
                    ...
                    <div class="text-emerald-500 font-bold text-sm tracking-wide mb-2">Welcome Back</div>
                    <h2 class="text-4xl sm:text-[2.75rem] leading-[1.1] font-outfit font-black tracking-tighter text-white mb-2 uppercase">SIGN IN TO <br>MONEYTRACK</h2>
                </div>
                ...
                <div>
                    <form method="POST" action="{{ route('login') }}" class="space-y-5">
                        ...
                        <div>
                            <label for="email" class="block text-xs font-bold text-white/80 mb-2">Email Address</label>
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                <label for="password" class="block text-xs font-bold text-white/80">Password</label>
                            </div>
                        ...
                        <div class="flex items-center justify-between mt-4">
                            <div class="flex items-center">
                                <input id="remember" type="checkbox" name="remember" class="w-4 h-4 rounded border-white/10 bg-transparent text-emerald-500 focus:ring-emerald-500 transition-all cursor-pointer">
                                <label for="remember" class="ml-2 block text-xs font-medium text-white/60 cursor-pointer">Remember me</label>
                            </div>
                            <a href="#" class="text-xs font-medium text-emerald-500 hover:text-emerald-400 transition-colors">Forgot password?</a>
                        </div>
                    ...
                    <p class="mt-10 text-center text-sm font-medium text-white/40">
                        ...
                        <a href="{{ route('register') }}" class="text-emerald-500 hover:text-emerald-400 font-bold transition-colors ml-1">Create an Account</a>
                    </p>
                </div>
            </div>
        </div>
